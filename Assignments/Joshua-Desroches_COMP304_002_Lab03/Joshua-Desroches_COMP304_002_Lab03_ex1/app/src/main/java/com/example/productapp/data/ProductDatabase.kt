                        ...
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            CoroutineScope(Dispatchers.IO).launch {
                                getDatabase(context).productDao().insertSampleProducts(
                                    listOf(
                                        Product(101, "Phone", 299.99, 1, "2025-04-01", "Electronics", false),
                                        Product(102, "Laptop", 999.99, 1, "2025-04-02", "Electronics", true),
                                        Product(103, "Microwave", 149.99, 1, "2025-04-03", "Appliances", false)
                                    )
                                )
                            }
                        }
